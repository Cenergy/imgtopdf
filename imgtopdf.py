...
tk.Label(window,text='图片字段(可无)').place(x=10,y=80)
var2=tk.StringVar()
var2.set('图片1')
tk.Entry(window,textvariable=var2,width=40).place(x=100,y=80)

tk.Label(window,text='另存名字').place(x=20,y=140)
var3=tk.StringVar()
var3.set('PDF的名字')
...
tk.Button(window,text='ImgToPdf',width=50,command=imgtopdf).place(x=20,y=200)
window.mainloop()
